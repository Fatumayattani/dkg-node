...
import pluginAlleLabsPlugin from "../dist/index.js";
import {
  createExpressApp,
...
describe("@dkg/plugin-alle-labs checks", function () {
  ...
  beforeEach(async () => {
    ...
    // Initialize plugin
    pluginAlleLabsPlugin(mockDkgContext, mockMcpServer, apiRouter);
    await connect();
    app.use("/", apiRouter);
  });
  ...
  describe("Plugin Configuration", () => {
    it("should create plugin without errors", () => {
      expect(pluginAlleLabsPlugin).to.be.a("function");
    });
  });
